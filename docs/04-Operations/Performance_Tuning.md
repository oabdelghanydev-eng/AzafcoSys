# Performance & Caching Strategy - الأداء والتخزين المؤقت

## 📋 نظرة عامة

استراتيجيات تحسين أداء النظام والتخزين المؤقت.
...
-- ⚠️ FIFO يعتمد على shipments.date وليس created_at - يحتاج JOIN
...
| البيانات | TTL | السبب |
|----------|-----|-------|
| Settings | 1 hour | نادراً يتغير |
| Products | 24 hours | ثابت |
| Suppliers | 1 hour | نادراً يتغير |
| Dashboard Stats | 5 minutes | يتغير باستمرار |
| User Permissions | 1 hour | عند تسجيل الدخول |
