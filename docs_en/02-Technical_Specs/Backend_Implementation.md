...
$products = [
    ['code' => 'PRD-001', 'name' => 'Item 1', 'default_price' => 0],
    // ... 9 products
];

// AccountSeeder.php
Account::create(['type' => 'cashbox', 'name' => 'Main Cashbox']);
Account::create(['type' => 'bank', 'name' => 'Main Bank']);
        ...
        'total' => [
            ...
            function ($attribute, $value, $fail) {
                if ($value < $this->invoice->paid_amount) {
                    $fail("Cannot reduce total below paid amount ({$this->invoice->paid_amount})");
                }
            },
        ],
    ];
